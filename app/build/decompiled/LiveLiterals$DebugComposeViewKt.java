...
public final class LiveLiterals$DebugComposeViewKt {
   ...
   @NotNull
   private static String String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView = "action is ";
   @Nullable
   private static State State$String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView;
   @NotNull
   private static String String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView = "Dispatched touch event ";
   @Nullable
   private static State State$String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView;
   ...
   public final String String$0$str$arg_0$call_println$fun_dispatchTouchEvent$class_DebugComposeView/* $FF was: String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView*/() {
      if (!LiveLiteralKt.isLiveLiteralsEnabled()) {
         return String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView;
      } else {
         State var10000 = State$String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView;
         if (var10000 == null) {
            State var1 = LiveLiteralKt.liveLiteral("String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView", String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView);
            State$String$0$str$arg-0$call-println$fun-dispatchTouchEvent$class-DebugComposeView = var1;
            var10000 = var1;
         }
   ...
   @LiveLiteralInfo(
      key = "String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView",
      offset = 9378
   )
   @NotNull
   public final String String$0$str$arg_0$call_println$branch$if$fun_dispatchTouchEvent$class_DebugComposeView/* $FF was: String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView*/() {
      if (!LiveLiteralKt.isLiveLiteralsEnabled()) {
         return String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView;
      } else {
         State var10000 = State$String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView;
         if (var10000 == null) {
            State var1 = LiveLiteralKt.liveLiteral("String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView", String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView);
            State$String$0$str$arg-0$call-println$branch$if$fun-dispatchTouchEvent$class-DebugComposeView = var1;
            var10000 = var1;
         }
