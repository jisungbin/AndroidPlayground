...
public val QuackIcon.Home224Fill: ImageVector
    get() {
        if (_home224Fill != null) {
            return _home224Fill!!
        }
        _home224Fill = Builder(name = "Home224Fill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFFFF8300)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.0f, 17.0f)
                lineTo(15.0f, 17.0f)
...
private var _home224Fill: ImageVector? = null
