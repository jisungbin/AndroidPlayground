...
/**
 * 임의의 타입 [T] 에서 [AnimationVector] 로 변환하고 [AnimationVector] 를 다시 타입 [T] 로 변환하는 방법에 대한 정의가 포함되어 있습니다.
 * 이를 통해 애니메이션을 모든 타입의 개체에서 실행할 수 있습니다.
 */
interface TwoWayConverter<T, V : AnimationVector> {
    /**
     * 타입 [T] 을 [AnimationVector] 타입으로 변환하는 방법을 정의합니다.
     */
    val convertToVector: (T) -> V

    /**
     * [AnimationVector] 타입을 다시 타입 [T] 로 변환하는 방법을 정의합니다.
     */
